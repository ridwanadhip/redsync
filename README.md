...
FORK OF ORIGINAL REDSYNC (https://github.com/go-redsync/redsync) THAT DOESN'T DEPENDS TO GO-REDIS LIBRARY
SEE ORIGINAL REPO FOR ADDITIONAL INFO AND LATEST UPDATE
